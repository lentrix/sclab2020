...
<div class="row">
    ...
    <div class="col-md-6">
        {!! Form::model($patient,['url'=>"/patients/$patient->id", 'method'=>'put']) !!}
            ...
            <div class="form-group">
                ...
                {{Form::date('bdate',$patient->bdate, ['class'=>'form-control'])}}
            </div>
            ...
            <form-group>
                <button class="btn btn-primary float-right" type="submit">Update Patient</button>
            </form-group>
